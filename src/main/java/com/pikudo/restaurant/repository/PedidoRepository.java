...
import com.pikudo.restaurant.dto.reporte.ReporteDTO.FlujoHorarioDTO;
import com.pikudo.restaurant.dto.reporte.ReporteDTO.ProductoMasVendidoDTO;
...
public interface PedidoRepository extends JpaRepository<Pedido, Long>, JpaSpecificationExecutor<Pedido> {
    ...
    @Query("SELECT new com.pikudo.restaurant.dto.reporte.ReporteDTO$ProductoMasVendidoDTO(" +
    ...
    @Query("SELECT new com.pikudo.restaurant.dto.reporte.ReporteDTO$FlujoHorarioDTO(HOUR(p.fechaCreacion), COUNT(p)) " +
           "FROM Pedido p " +
