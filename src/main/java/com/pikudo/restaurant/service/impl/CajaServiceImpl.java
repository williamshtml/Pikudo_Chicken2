...
import com.pikudo.restaurant.mapper.CajaMapper;
...
import com.pikudo.restaurant.entity.caja.Gasto;
    ...
    public CajaResumenDTO obtenerResumenParaCierre(Long cajaId) {
        ...
        return CajaResumenDTO.builder()
                ...
                .tienePagosParcialesPendientes(orderPaymentRepository.existsByCajaIdAndPedidoEstadoPago(
                        caja.getId(), com.pikudo.restaurant.entity.orders.OrderPaymentStatus.PARTIALLY_PAID))
                .build();
    }
